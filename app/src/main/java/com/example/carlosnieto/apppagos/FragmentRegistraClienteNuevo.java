 ...
 */
public class FragmentRegistraClienteNuevo extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_registra_cliente_nuevo,container,false);
        campoCedula= (EditText) vista.findViewById(R.id.txt_documentocliente);
        ...
        btn_GuardaCliente.setOnClickListener(new View.OnClickListener() {
            @Override
